...
const questionBanks={
  ...
  9:[
    ...
    {type:"multiple_choice",prompt:"Which angle is greater than 90° but less than 180°?",answer:"Obtuse",options:["Acute","Right","Obtuse","Reflex"],hint:"Think about angle categories.",hints:hintSet("Think about angle categories.","A right angle is exactly 90°.","The required angle is wider than a right angle but not a straight line.","That is an obtuse angle."),explanation:"An obtuse angle is between 90° and 180°.",topic:"Geometry",practice_prompt:"What type of angle is less than 90°?",practice_answer:"Acute"}
  ],
  10:[
    ...
    {type:"multiple_choice",prompt:"Which number is prime?",answer:"29",options:["21","27","29","33"],hint:"A prime number has exactly two factors.",hints:hintSet("A prime number has exactly two factors.","Test divisibility by small numbers.","21, 27 and 33 are divisible by 3.","29 has only factors 1 and 29."),explanation:"29 is prime.",topic:"Number",practice_prompt:"Which is prime: 31 or 35?",practice_answer:"31"}
  ],
  11:[
